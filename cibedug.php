...
<head>
    ...
    <title>Halaman Admin - Cibedug</title>
</head>
<body>
    <div class="hal-pemb">
        <nav class="nav">
        ...
        <h3 class="rayon">Cibedug</h3>
        <h3 class="tgl">15-09-2023 <button class="btn-ubah">Ubah</button></h3>
        <table class="tb-datsis">
            <tr>
                <th class="tb-th">No.</th>
                <th class="th">Rayon</th>
                <th class="th">Nama Pembimbing</th>
                <th class="th">Jadwal Masjid</th>
                <th class="tb-aksi">#</th>
            </tr>
        </table>
        <table class="tb-datsis2">
            ...
            <tr>
                <td class="tdd">4.</td>
                <td class="td">Cibedug 4</td>
                <td class="td">Pak Muslih</td>
                <td class="td">Al-Ikram</td>
                <td class="tdd"><a class="btn-edit" href="#">Edit</a></td>
            </tr>
            <tr>
                <td class="tb-no2">5.</td>
                <td class="td">Cibedug 5</td>
