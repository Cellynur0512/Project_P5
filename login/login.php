    ...
    <div class="card">
        <div id="card-content">
            ...
            <form method="post" class="form">
                ...
                <label><input type="checkbox">Login sebagai admin</label>
            </div>
            <div class="remember-forgot">
                <label><input type="checkbox">Login sebagai guru</label>
            </div>
            <input id="submit-btn" type="submit" name="submit" value="LOGIN">
            <p>Not a member <a href="signup.php" id="signup">Signup</a></p>
